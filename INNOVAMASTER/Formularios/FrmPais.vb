...
Public Class FrmPais
    ...
    '    End Try
    'End Sub
    'Private Sub DgvPais_CellClick(sender As Object, e As DataGridViewCellEventArgs) 
    ...
    'Private Sub DgvPais_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) 
    '    If var = 1 Then
